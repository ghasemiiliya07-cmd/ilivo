  ...
  "@graph": [
    {
      ...
      url: siteUrl,
      name: "ilivo",
      alternateName: "ایلیوو",
      description:
        "ilivo ارائه‌دهنده خدمات طراحی سایت حرفه‌ای، فروشگاهی، شرکتی و لندینگ پیج.",
      inLanguage: "fa-IR",
    },
    {
      ...
      url: siteUrl,
      description:
        "طراحی سایت حرفه‌ای، فروشگاهی و شرکتی با ilivo؛ طراحی مدرن، اختصاصی و سریع.",
      areaServed: {
        "@type": "Country",
        name: "Iran",
      },
...
const reviews = [
  [
    ...
    "علی رضایی",
    "مدیر املاک",
    "سایت جدید ما خیلی حرفه‌ای‌تر از چیزی شد که تصور می‌کردیم.",
  ],
  [
    "س",
    "سارا محمدی",
    "مدیر شرکت",
    "پشتیبانی سریع و طراحی دقیق، تجربه همکاری خیلی خوبی بود.",
  ],
  [
    "م",
    "محمد احمدی",
    "مدیر فروشگاه",
    "ilivo دقیقاً چیزی را ساخت که برای برندمان لازم داشتیم.",
  ],
];
...
export default function Home() {
  ...
  const projects =
    filter === "همه"
      ? portfolio
      : portfolio.filter((x) => x.type === filter);
    ...
    <main>
      ...
      <header className="sticky top-0 z-50 border-b border-white/[.06] bg-[#02050b]/85 backdrop-blur-xl">
        <div className="wrap flex h-[68px] items-center justify-between">
          ...
          >
            ...
            <a className="nav" href="#process">
              فرآیند کار
            </a>

            <a className="nav" href="#pricing">
              قیمت‌ها
            </a>
          ...
          <button
            ...
            aria-label="شروع پروژه با ilivo"
          >
            شروع پروژه
          </button>
        </div>
        ...
        <div className="wrap grid items-center gap-5 lg:grid-cols-[1fr_1.08fr]">
          <div className="hero-copy">
            ...
            <h1 id="hero-title">
              ...
              <span className="gradient">ilivo</span>
              <br />
              وب‌سایت مدرن برای رشد کسب‌وکار شما
            </h1>

            <p className="mt-5">
              ilivo خدمات طراحی سایت حرفه‌ای، فروشگاهی، شرکتی و
              لندینگ پیج را با طراحی مدرن، تجربه کاربری مناسب،
              سرعت بالا و ساختار آماده برای موتورهای جست‌وجو
              ارائه می‌دهد.
            </p>
            ...
            <div className="hero-buttons mt-7 flex gap-2.5 flex-wrap">
              ...
              <a
                className="outline rounded-xl px-6 py-3 text-[10px] font-black"
                href="#portfolio"
              >
                مشاهده نمونه‌کارها
              </a>
          ...
          <div className="hero-art">
            ...
            <img
              ...
              alt="طراحی سایت حرفه‌ای ilivo روی لپ‌تاپ و موبایل"
              width={1200}
              height={800}
              fetchPriority="high"
              decoding="async"
        ...
        <div className="wrap">
          <div className="text-center">
            <div className="eyebrow">
              پروژه‌هایی که با افتخار طراحی و اجرا کرده‌ایم
            </div>

            <h2 id="portfolio-title" className="title">
              نمونه‌کارهای طراحی سایت ilivo
            </h2>
          </div>
            ...
            {projects.map((p) => (
              ...
              >
                <img
                  ...
                  src={p.image}
                  alt={`${p.title} | نمونه‌کار طراحی سایت ilivo`}
                  width={1200}
                  height={800}
                  loading="lazy"
                  decoding="async"
      ...
      >
        <div className="wrap">
          <div className="text-center">
            <div className="eyebrow">
              راهکارهای دیجیتال متناسب با نیاز شما
            </div>

            <h2 id="services-title" className="title">
              خدمات طراحی سایت ilivo
            </h2>
          </div>
      ...
      <section className="section pt-5">
        <div className="wrap">
          <div className="text-center">
            <div className="eyebrow">
              تجربه، کیفیت و همراهی در کنار شما
            </div>
      ...
      >
        <div className="wrap">
          <div className="text-center">
            ...
            <h2 id="process-title" className="title">
              فرآیند طراحی سایت
            </h2>
          </div>
          ...
          <div className="prices">
            <div className="price glass">
              ...
              <div className="price-num">
                ۵,۹۰۰,۰۰۰ <small>تومان</small>
              </div>

              <ul>
                <li>✓ طراحی تا ۵ صفحه</li>
                <li>✓ ریسپانسیو</li>
                <li>✓ پنل مدیریت</li>
              ...
              <a
                className="outline price-btn"
                href={waLink(
                  "سلام ilivo 👋\nبرای پکیج شروع طراحی سایت پیام می‌دهم."
                )}
                target="_blank"
                rel="noreferrer"
              >
            ...
            <div className="price glass popular">
              ...
              <div className="price-num">
                ۹,۹۰۰,۰۰۰ <small>تومان</small>
              </div>

              <ul>
                <li>✓ طراحی تا ۱۰ صفحه</li>
                <li>✓ ریسپانسیو</li>
              ...
              <a
                ...
                href={waLink(
                  "سلام ilivo 👋\nبرای پکیج حرفه‌ای طراحی سایت پیام می‌دهم."
                )}
                target="_blank"
                rel="noreferrer"
              >
            ...
            <div className="price glass">
              ...
              <a
                className="outline price-btn"
                href={waLink(
                  "سلام ilivo 👋\nبرای پروژه اختصاصی سایت می‌خواهم مشاوره بگیرم."
                )}
                target="_blank"
                rel="noreferrer"
              >
      ...
      <section className="section pt-5">
        <div className="wrap">
          <div className="text-center">
            <div className="eyebrow">
              مشتریان درباره همکاری با ما چه می‌گویند؟
            </div>
        ...
        <div className="wrap">
          <div className="cta">
            <img
              ...
              alt="محیط کاری مدرن برای طراحی سایت ilivo"
              width={1200}
              height={800}
              loading="lazy"
              decoding="async"
          ...
          <form
            className="glass rounded-[14px] p-5 mt-4"
            onSubmit={submit}
          >
            <div className="text-center">
              <div className="eyebrow">
              ...
              <h2 className="title text-[22px]">
                اطلاعات پروژه را بفرستید
              </h2>

              <p className="subtitle">
                بعد از زدن دکمه، واتساپ با متن آماده برای شما باز می‌شود.
              </p>
            </div>
            ...
            <div className="contact-box">
              ...
              <textarea
                ...
                name="details"
                required
                placeholder="توضیح کوتاه درباره سایت، امکانات یا بودجه موردنظر..."
                aria-label="توضیحات پروژه"
              />

              <button
                className="primary contact-full rounded-xl py-3 text-[10px] font-black"
                type="submit"
              >
                {sent
          ...
          <div className="project-modal">
            ...
            <div className="modal-head">
              ...
              <h2 id="project-modal-title">
                پروژه‌ات را همین‌جا شروع کن ✦
              </h2>

              <p>
                سه مورد کوتاه را انتخاب کن، بعد با یک کلیک اطلاعات
                آماده را به واتساپ بفرست.
              </p>
            </div>
      ...
      <footer className="footer">
        <div className="wrap footer-grid">
          <div>
            ...
            <p>
              طراحی و توسعه سایت‌های حرفه‌ای برای برندهایی که
              می‌خواهند متفاوت دیده شوند.
            </p>
          </div>
        ...
        <div className="copyright">
          © ۲۰۲۶ ilivo. تمامی حقوق محفوظ است.
        </div>
      </footer>
    </main>
  );
